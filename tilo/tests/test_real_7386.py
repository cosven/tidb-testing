...
def test_real_issue_7386():
    log.msg('test real 7386')
    ...
    log.msg(f'{store_ids}, {target_store}')
    ...
    pd.remove_peer(region_id, target_store)
    log.msg('sleep for 1s to wait remove peer')
    time.sleep(1)
